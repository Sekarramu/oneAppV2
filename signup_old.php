...
<head>
    <meta charset="utf-8" />
    <title>SUS Terminology Challenge</title>
...
<div class="row">
<div class="col-md-5">
    <h1><span class="blue">SUS Terminology Challenge</span></h1>
</div>
...
<img src="images/sysco.png" alt="Sysco" width="50%" height="25%" class="surveyImg">
