...
<title>Admin | Certification Details</title>
  ...
  background: #333333;
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="certiStatus.php"><svg class="glyph stroked clock"><use xlink:href="#stroked-clock"></use></svg>Modify Certification</a></li>
...
$username1 = 'Sekar_Ramu';
								$fetchCertiQuery = "select * from certification";
