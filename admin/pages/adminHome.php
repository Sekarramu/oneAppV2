...
<style>
  ...
  background: #222222;
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<ul class="nav menu">
			<li class="active"><a href="adminHome.php"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg>Dashboard</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Pages / Update Employee</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-12">
			<button class="btn btn-primary" onclick="addQuestionShow()">Add Employee</button> &nbsp;&nbsp; <!--sekar<button class="btn btn-info" onclick="updateQuestionShow()">Update Employee</button> sekar-->
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="../tables/data2.json" class="table table-hover">
							...
							<?php
								...
								$fetchQuestionQuery = "select * from employee";
								...
								while ($fetchQuestionRow = $fetchQuestionQueryResult->fetch_assoc()) {
										...
										document.getElementById('modeoftransport').value = '".$fetchQuestionRow['modeoftransport']."';
										document.getElementById('email').value = '".$fetchQuestionRow['email']."';
										document.getElementById('address').value = '".$fetchQuestionRow['address']."';	
		...
		<div class="row" id="addQuestionForm" style="display:none;">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="../php/addEmployee.php" method="POST">
						...
						<div class="col-md-6">
							<form role="form" action="../php/updateEmployee.php" method="POST">
								...
								<div class="form-group">
									...
									<input type="text" name="name"  id="name" class="form-control" placeholder="Please Enter Employee name" >
								</div>
								...
								<div class="form-group">
									<label>Infosys ID</label>
									<input type="text" name="email"  id="email"  class="form-control" placeholder="Please Enter Infosys ID">
								</div>
